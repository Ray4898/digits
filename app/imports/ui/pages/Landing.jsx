        ...
        <Grid container stackable centered columns={3}>
          <Grid.Column textAlign='center' >
            ...
            <Header as='h3' inverted>
              This address book enables any number of users to register and save their bussiness contracts.
          ...
          <Grid.Column textAlign='center' >
            ...
            <Header as='h3' inverted>
              ...
              summarizes the conversation This note is saved along with a timestamp with the contact.
            </Header>
          </Grid.Column>
        </Grid>
        </div>
