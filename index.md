...
You can now add new contact documents, and list the Stuff you have created. Note you cannot see any contact created by other users.

#### Add contact page

After logging in, here is the page that allows you to add new contact:

<img src="doc/useraddc.PNG">
